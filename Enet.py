...
def Enet(input_shape = (512,512,3), num_classes = 8):
	...
	fullconv = Conv2DTranspose(num_classes, 3, strides = (2,2), padding = 'same', output_padding = 1, use_bias = False, activation = 'softmax')(x)

	# reshape= Reshape((-1,num_classes))(fullconv)
	...
	model.compile(optimizer = Adam(lr = 1e-4), loss=iou, metrics=['accuracy'])
